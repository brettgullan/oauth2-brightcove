<?php namespace Brettgullan\OAuth2\Client\Test\Provider;

use Mockery as m;

class BrightcoveTest extends \PHPUnit_Framework_TestCase
{
    protected $provider;

    protected function setUp()
    {
        $this->provider = new \Brettgullan\OAuth2\Client\Provider\Brightcove([
    ...
    public function testGetBaseAccessTokenUrl()
    {
        ...
        $this->assertEquals('/v3/access_token', $uri['path']);
    }
    ...
    public function testUserData()
    {
        ...
        $userResponse->shouldReceive('getBody')->andReturn('{"created_on": "2011-12-20T16:34:07.132459+00:00","display_name": "'.$name.'","location": "'.$location.'","type": "user","username": "'.$username.'","uuid": "'.$userId.'","website": "https://tutorials.Brightcove.org/"}');
